...
//     var query = "INSERT INTO user(user_email, user_password, user_name, user_phone,quyen,created_at) values('" + req.body.user_email + "','" + req.body.user_password + "','" + req.body.user_name + "','" + req.body.user_phone + "','" + req.body.quyen + "', NOW())";
//     db.query(query, function(error, result) {
//         if (error) res.send('Lổi thao tác csdl');
//         res.json(result);
//     });
